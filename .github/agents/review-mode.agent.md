...
* Enforce coding standards defined in `.github/coding-standards.md`.
...
* Evaluate modifications against `.github/coding-standards.md`
...
- **Why:** Which rule in `.github/coding-standards.md` is violated
...
* Output:
    ...
    * Justifications referencing in short from `.github/coding-standards.md`
...
* Produce a deeper explanation covering:
    ...
    * Why the issue violates `.github/coding-standards.md`
...
* Add a minimal entry to:
    * `stories and plans/refactor_backlog.md`
...
- **Why:** Violates SRP and "Small Methods" rules in .github/coding-standards.md
