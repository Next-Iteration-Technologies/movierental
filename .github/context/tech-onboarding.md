...
This repository contains a self-contained refactoring exercise in Java:
...
**Big picture & intent**
- The exercise lives under `src/main/java/movierental`. Changes should keep this exercise self-contained.
...
- Prefer small, well-named methods when extracting behavior from large switch/case blocks (see: `Customer.statement()` in [movierental/Customer.java](src/main/java/movierental/Customer.java#L23-L64)).
